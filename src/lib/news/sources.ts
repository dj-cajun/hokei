...
export const NEWS_TOPIC_SOURCES: NewsTopicConfig[] = [
  {
    ...
    categorySlug: "news",
    feeds: [
      { type: "naver", query: "한국 베트남 교민", sourceName: "네이버 뉴스" },
      { type: "naver", query: "한국 베트남 관계", sourceName: "네이버 뉴스" },
  ...
  },
  {
    ...
    categorySlug: "news",
    feeds: [
      { type: "naver", query: "한국인 베트남 여행", sourceName: "네이버 뉴스" },
      { type: "naver", query: "한국 베트남 여행", sourceName: "네이버 뉴스" },
      { type: "naver", query: "대한항공 베트남", sourceName: "네이버 뉴스" },
  ...
  },
  {
    ...
    feeds: [
      ...
      { type: "naver", query: "베트남 거주증 이민", sourceName: "네이버 뉴스" },
  ...
  },
  {
    ...
    categorySlug: "news",
    feeds: [
      { type: "naver", query: "한국인 호치민 관광", sourceName: "네이버 뉴스" },
      { type: "naver", query: "한국인 베트남 여행객", sourceName: "네이버 뉴스" },
      { type: "naver", query: "한국 교민 베트남", sourceName: "네이버 뉴스" },
    ],
  },
];
